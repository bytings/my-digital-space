  ...
  const projects = [
    {
      ...
      icon: Building,
      technologies: ["C# .NET Core", "JavaScript", "SQL Server", "Azure DevOps (ALM)", "Microservices"],
    ...
    },
    {
      ...
      icon: ShoppingCart,
      technologies: ["C# .NET Core", "Angular", "JavaScript", "SQL Server", "Docker", "AWS"],
    ...
    },
    {
      ...
      icon: Monitor,
      technologies: ["C# .NET Core", "Win32API", "WebSockets", "Angular", "JavaScript", "SQL Server"],
    ...
    },
    {
      ...
      icon: MapPin,
      technologies: ["C# .NET Core", "Angular", "JavaScript", "SQL Server", "Docker", "Real-time GPS"],
    ...
    },
    {
      ...
      icon: Building,
      technologies: ["C# .NET Core", "Angular", "JavaScript", "SQL Server", "Docker", "GitLab"],
